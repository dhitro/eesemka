			...
			<tr>
				...
				<td class="">
					...
					<div class="place-action">
						<a href="<?= base_url('admin/lamaran_approve/') ?>" data-id="<?= $d->id ?>" class="approved" title="Approve">Approve</a>
						<a href="<?= base_url('admin/lamaran_approve/') ?>" data-id="<?= $d->id ?>" class="pending" title="Pending">Pending</a>
						<a href="<?= base_url('admin/lamaran_approve/') ?>" data-id="<?= $d->id ?>" class="reject" title="Reject">Reject</a>
					</div>
				</td>
			</tr>
		<?php endforeach; ?>
