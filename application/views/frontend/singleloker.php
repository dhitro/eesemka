						...
						<div class="col-lg-8">
							<div class="place__left">
								<div class="place__box place__box--npd">
									<h1></h1>
                                    <h1>Lowongan Kerja Desain Grafis Part Time</h1>
								</div><!-- .place__box -->
								...
								<div class="place__box place__box-open">
	                                ...
	                                <table class="open-table">
	                                	<tbody>
	                                		<tr>
	                                			<td class="day">Lulusan</td>
												<td class="time">S1</td>
	                                		</tr>
                                            <tr>
	                                			<td class="day">Usia</td>
												<td class="time">19-23 tahun</td>
	                                		</tr>
                                            <tr>
	                                			<td class="day">Pengalaman</td>
												<td class="time">3 Tahun Bekerja</td>
	                                		</tr>
	                                	</tbody>
	                                </table>
								</div><!-- .place__box -->
									...
									<form action="#" method="POST" class="form-underline">
										<div class="field-select has-sub field-guest">
											...
											<select name="price_range" id="price_range">
                                                ...
                                                <option value="2">Videografi</option>
                                            </select>
										</div>
